...
from .base import DAEMON_DIR, DAEMON_LOG_DIR
...
class Profile(object):
    ...
    def uuid(self):
        ...
        """
        return self.dictionary[self.PROFILE_UUID_KEY]
    ...
    def uuid(self, uuid):
        ...
        """
        self.dictionary[self.PROFILE_UUID_KEY] = uuid
    ...
    def default_user_email(self):
        ...
        :rtype: str
        """
        from aiida.common.setup import DEFAULT_USER_CONFIG_FIELD as key

        try:
            email = self.dictionary[key]
        except KeyError:
            raise exceptions.ConfigurationError('"{}" not found in the configuration file'.format(key))
