...
from aiida.common.setup import create_config_noninteractive, create_base_dirs, _property_table, exists_property, get_property, del_property
...
class TestVerdiDevel(AiidaTestCase):
    ...
    def setUpClass(cls, *args, **kwargs):
        ...
        cls._old_aiida_config_folder = base.AIIDA_CONFIG_FOLDER
        cls._old_config = config_module.CONFIG

        config_module.CONFIG = None
        base.AIIDA_CONFIG_FOLDER = cls._new_aiida_config_folder
        create_base_dirs()
        ...
        cls.dummy_profile['repo'] = base.AIIDA_CONFIG_FOLDER + '/repository_' + cls.profile_name
    ...
    def tearDownClass(cls, *args, **kwargs):
        ...
        base.AIIDA_CONFIG_FOLDER = cls._old_aiida_config_folder
